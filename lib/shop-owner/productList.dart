        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                int productPrice =
                    data['sellingPrice']; // Fetch selling price from Firestore
                productPrices[productName] =
                    productPrice.toDouble(); // Store selling price in the map
                ...
                String price = '\Tsh ${_format.format(data['sellingPrice'])}';
                return Container(
                  child: Padding(
